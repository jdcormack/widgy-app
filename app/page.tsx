  ...
  return (
    <main className="relative flex flex-col min-h-screen bg-white">
      ...
      <section className="mx-5">
        <div className="relative flex items-center justify-center h-96 overflow-hidden max-w-8xl w-full mx-auto rounded-xl m-5">
          ...
          <div className="relative z-10 w-full max-w-xl space-y-8 max-sm:px-5">
            <h1 className="text-4xl font-black text-gray-900 mb-4">
              Gather feedback.{" "}
              <span className="text-blue-600">Plan better.</span>{" "}
